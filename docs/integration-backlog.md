...
| `Quantum-L9/l9-pr-repair` | `l9.repair-learning-packet/v1` | `PR_Repair` does not emit the contract, and in v0.1 it is a standalone PR assistant outside the debt pipeline entirely. |
